        ...
        },
        {
            ...
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="24" viewBox="0 0 27 24" fill="none">
                    <path d="M23.9314 1.5H5.93141C3.72227 1.5 1.93141 3.29086 1.93141 5.5V5.5V19.5C1.93141 20.1491 2.14195 20.7807 2.53141 21.3V21.3C3.09797 22.0554 3.98714 22.5 4.93141 22.5H20.4314C23.1928 22.5 25.4314 20.2614 25.4314 17.5V17.5V9.95774C25.4314 9.33104 25.2611 8.71613 24.9387 8.17875V8.17875C24.3138 7.13726 23.1882 6.5 21.9737 6.5H6.43141" stroke="#98989E" strokeWidth="2.5" strokeLinecap="round"/>
                    <path d="M19.6814 13C18.7149 13 17.9314 13.7835 17.9314 14.75C17.9314 15.7165 18.7149 16.5 19.6814 16.5C20.6479 16.5 21.4314 15.7165 21.4314 14.75C21.4314 13.7835 20.6479 13 19.6814 13Z" stroke="#98989E" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            )
        }
    ]
